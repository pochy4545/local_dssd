...
class UnidadesTest < ApplicationSystemTestCase
  ...
  test "creating a Unidade" do
    ...
    fill_in "Coordenadas", with: @unidade.coordenadas
    fill_in "Email", with: @unidade.email
    fill_in "Nombre", with: @unidade.nombre
    fill_in "Numerounidad", with: @unidade.numeroUnidad
