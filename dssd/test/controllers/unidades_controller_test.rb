...
class UnidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidade" do
    assert_difference('Unidade.count') do
      post unidades_url, params: { unidade: { coordenadas: @unidade.coordenadas, email: @unidade.email, nombre: @unidade.nombre, numeroUnidad: @unidade.numeroUnidad } }
    end
  ...
  test "should update unidade" do
    patch unidade_url(@unidade), params: { unidade: { coordenadas: @unidade.coordenadas, email: @unidade.email, nombre: @unidade.nombre, numeroUnidad: @unidade.numeroUnidad } }
